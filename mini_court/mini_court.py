...
constants_path = os.path.abspath(os.path.join(project_root, 'new/constants'))

sys.path.append(project_root)  # Add the project root
sys.path.append(constants_path)  # Add the constants directory
...
from new.utils import (
    convert_meters_to_pixel_distance,get_closest_keypoint_index,measure_distance,get_center_of_bbox,get_foot_position,
    get_height_of_bbox,measure_xy_distance,convert_pixel_distance_to_meters
)
